<template>
    <Listbox as="div" v-model="selected">
      <div class="relative">
        ...
        <ListboxButton class="relative w-full cursor-default bg-white pl-3 pr-10 text-left text-gray-900 focus:outline-none text-[11px]" :class="[buttonHeight,showBorder]">
