    ...
    <div class="relative inline-block text-left mr-3">
        <div>
            <button @click="isShow = !isShow" type="button"
                class="inline-flex w-full uppercase text-[12px] justify-center h-[34px]  border border-[#EAEAEA] bg-white px-4 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100"
