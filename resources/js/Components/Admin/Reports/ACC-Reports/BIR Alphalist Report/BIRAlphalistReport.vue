...
import Alphalist1601ETable from "./Tables/Alphalist1601ETable.vue";
import ReliefSalesTable from "./Tables/ReliefSalesTable.vue";
import ReliefPurchasesTable from "./Tables/ReliefPurchasesTable.vue";
export default {
    name: 'BIR Alphalist Report',
    components: {
        NormalButton, SearchIcon, ListIcon, DateInput,
        CheckboxSelectMenu, Alphalist1601ETable,
        ReliefSalesTable, ReliefPurchasesTable
    },
    data() {
        return {
            reportType:[
                {label: 'alphalist 1601e'},
                {label: 'relief_sales'},
                {label: 'relief_purchases'},
            ],
            selectedReport: '',
            selectedSupplier: '',
            startDate: '',
    ...
    <div class="w-full h-screen bg-white">
        <div class="flex flex-col gap-[15px] min-w-full px-3 pt-10 pb-5">
            <div class="flex gap-[10px] w-[85%] mx-[12px]">
                <div class="flex items-center gap-[10px] w-[40%]">
                    <div class="w-full">
        ...
        <!-- MAIN CONTENT -->
        <div v-if="this.selectedReport.label == 'alphalist 1601e' && this.startDate && this.endDate">
            <Alphalist1601ETable :Report="selectedReport.label" :StartDate="this.startDate" :EndDate="this.endDate"/>
        </div>
        <div v-else-if="this.selectedReport.label == 'relief_sales' && this.startDate && this.endDate">
            <ReliefSalesTable :Report="selectedReport.label" :StartDate="this.startDate" :EndDate="this.endDate"/>
        </div>
        <div v-else-if="this.selectedReport.label == 'relief_purchases' && this.startDate && this.endDate">
            <ReliefPurchasesTable :Report="selectedReport.label" :StartDate="this.startDate" :EndDate="this.endDate"/>
        </div>
