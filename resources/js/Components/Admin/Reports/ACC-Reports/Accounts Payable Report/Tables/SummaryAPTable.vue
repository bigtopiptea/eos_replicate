        ...
        async getSummaryAP() {
            await axios.get(`/api/billers?page=${this.pagination.current_page}`)
                .then((response) => {
                  ...
                  this.SummaryAP = response.data.data;
...
<div class="flex flex-col h-auto pb-10">
            ...
            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 m-2 ">
                <table class="min-w-full divide-y divide-gray-300 overflow-x-scroll">
                    ...
                    <tfoot class="text-[10px] font-semibold bg-[#D7D7D7]">
                        <tr>
                            <td colspan="2" class="whitespace-nowrap text-right uppercase py-2 px-1 tracking-wider">500,000.00</td>
                            <td class="whitespace-nowrap text-right uppercase py-2 px-1 tracking-wider">250,000.00</td>
                            <td class="whitespace-nowrap text-right uppercase py-2 px-1 tracking-wider">250,000.00</td>
                            <td class="whitespace-nowrap text-right uppercase py-2 px-1 tracking-wider">50.00%</td>
                            <td colspan="2" class="whitespace-nowrap text-right uppercase py-2 px-1 tracking-wider"></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
    ...
    <Pagination @paginate="getSummaryAP()" :pagination="pagination"
            :offset="1" class="mt-8" />
</div>
</template>