...
export default{
    ...
    methods: {
        async getAdditionalFeeTable() {
            await axios.get(`/api/billers?page=${this.pagination.current_page}`)
                .then((response) => {
                    console.log(response.data);
                  this.AdditionalFeeTable = response.data.data;
    ...
    <div class="flex flex-col h-auto pb-10">
        <div class="flex flex-col justify-between uppercase mb-[30px]">
            ...
            <div class="text-center mt-[20px]">
                <h3 class="text-[14px] font-semibold">{{ ReportType }}</h3>
        ...
        <Pagination @paginate="getAdditionalFeeTable()" :pagination="pagination"
                :offset="1" class="mt-8" />
    </div>
