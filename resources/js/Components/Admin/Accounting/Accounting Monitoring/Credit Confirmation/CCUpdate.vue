                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-[#D7D7D7] font-medium text-[11px] whitespace-nowrap sticky top-0">
                                <tr class="divide-x divide-gray-200">
                                    <th scope="col"
                                        class="flex items-center justify-center gap-[10px] py-1 px-5 whitespace-nowrap uppercase tracking-wider text-center text-gray-900 ">
                                        <input type="checkbox">
                                        id
                                    </th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white font-light text-[10px] text-center">
                                <tr class="divide-x divide-gray-200">
                                    <td
                                        ...
                                        <input type="checkbox">
                                        <p @click="(approvalDetailsOpen = !approvalDetailsOpen)" class="underline text-cyan-500">
                                            01
                                        </p>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        ...
                                        <div class="flex justify-around">
                                            ...
                                            <button @click="(replyOpen = !replyOpen)" class="tooltip tooltip-left" data-tip="update">
                                                <img src="../../../../../../assets/images/load-icon.png" alt="Load Icon" class="h-5 w-5">
                                            </button>
                                        </div>
                                    </td>
                                </tr>
