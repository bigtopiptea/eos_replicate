...
<template>
    ...
    <Slideover :show="replyOpen" @close="replyToggle" :title="'PROFILE'" :iconShow="''">
        <div class="flex flex-col justify-between h-full pb-3">
            ...
            <div class="flex justify-center">
                <BorderButton @click.prevent="replyToggle()" :buttonLabel="'CLOSE'" :buttonPadding="'p-2'" :buttonTextColor="'text-[#3e3e3e]'" :buttonBorderColor="'border-[#3e3e3e]'" :buttonHover="'hover:bg-[#3E3E3E]'" :buttonTextSize="'text-[15px]'"/>
            </div>
        </div>
    </Slideover>
</template>
