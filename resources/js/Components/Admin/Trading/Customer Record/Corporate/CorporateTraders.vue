...
<template>
    <div class="my-[30px]">
        <div>
            <SmallHeading label="TRADER/S" class="pl-6 w-[10%]" />
            <!-- TABLE -->
                            ...
                            <thead class="bg-[#D7D7D7] font-medium text-[11px] whitespace-nowrap">
                                <tr class="divide-x divide-gray-200">
                                    <th v-for="label in labels" :key="label.label" scope="col"
                                        class="py-2 px-2 uppercase tracking-wider text-center text-gray-900">
                                        {{ label.label }}
                                    </th>
                                </tr>
                            </thead>
                        ...
                        <form class="flex flex-col gap-y-[15px] w-full">
                            ...
                            <div class="flex justify-between w-full gap-x-[5px]">
                                <div class="flex gap-x-[5px] w-[77.7%]">
                                    ...
                                    <div class="w-[27%]">
                                        <FloatingLabelInput :inputLabel="'position'" :inputWidth="'w-12/12'" :inputType="'number'" :inputColor="'bg-white'" :isRequired="true"/>
                                    </div>
                                </div>
                                <div class="flex justify-end gap-x-[5px] w-auto">
                                    <BorderButton :buttonLabel="'ADD/UPDATE TRADER'" :buttonSize="'h-auto w-[210px]'" :buttonPadding="'px-[5px] py-1'"/>
                                </div>
                            </div>
                        </form>
                    </div>
