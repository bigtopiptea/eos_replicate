...
<template>
    <div>
        <div class="flex flex-col justify-between h-full w-full px-3 py-5">
            <div>
                <div class="inline-block min-w-full align-middle ">
                    <div class="flex items-start justify-between h-auto min-w-full ">
                        <div class="right-side flex">
                            <form class="flex items-start gap-3">
                                <div class="flex">
                                    ...
                                    class="p-1.5 px-3 uppercase h-[34px] bg-[#3E3E3E] tracking-wider text-[10px] text-white mr-3" />
                            </form>
                        </div>
                        <div>
        ...
        <div class="flex flex-col justify-between mx-5 mb-5 mt-[20px] h-full">
            <div class="flex justify-between">
                ...
                <router-link to="/app/trading/customer-record/corporate">
                    <div class="corp-client flex flex-col justify-center items-center">
                        <svg class="h-[176px] w-[196px] border-[3px] border-[#F9951E] hover:bg-[#F9951E]" fill="none" stroke="#F9951E" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
