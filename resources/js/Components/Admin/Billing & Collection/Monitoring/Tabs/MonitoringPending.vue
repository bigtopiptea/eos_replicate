...
export default {
    ...
    methods: {
        async getBCMonitoringPending() {
            await axios.get(`/api/billers?page=${this.pagination.current_page}`)
                .then((response) => {
                    console.log(response.data);
                    this.BCMonitoringPending = response.data.data;
...
<template>
    <div class="flex flex-col justify-between h-full w-auto my-5 px-3 bg-white">
                                    ...
                                    <td
                                        ...
                                        <div class="flex justify-evenly">
                                            ...
                                            <button class="tooltip tooltip-left" data-tip="decline">
                                                <img src="../../../../../../assets/images/RejectIcon.png" alt="Decline Icon" class="h-5 w-5">
                                            </button>
                                        </div>
                                    </td>
                                </tr>
        ...
        <Pagination @paginate="getBCMonitoringPending()" :pagination="pagination"
