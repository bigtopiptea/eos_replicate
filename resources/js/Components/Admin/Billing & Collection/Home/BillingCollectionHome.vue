          ...
          datasets: [
            {
              ...
              data: [0, 39, 60, 40, 39, 80, 40, 100, 20, 68, 45, 80, 10]
            },
            {
              label: 'PAYMENTS',
              backgroundColor: '#EE3E2C',
              data: [25, 34, 100, 42, 25, 70, 80, 21, 0, 42, 38, 60, 50]
            }
          ]
        },
          ...
          datasets: [
            {
              label: 'BUILD SOA',
              backgroundColor: '#F9951E',
              data: [15, 32, 28, 7, 11, 25, 25, 30, 18, 26, 12, 3, 34]
            },
            {
              label: 'OPEN SOA',
              backgroundColor: '#EE3E2C',
              data: [7, 11, 25, 25, 30, 25, 15, 32, 28, 7, 11, 25, 35, 18, 20]
            }
          ]
        },
