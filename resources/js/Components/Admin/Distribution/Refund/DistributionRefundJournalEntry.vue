    ...
    <div class="sm:px-6 lg:px-8">
        <div class="inline-block min-w-full py-4 align-middle ">
            ...
            <div class="flex justify-center space-x-4 items-center w-full h-auto my-10">
                <button class=" uppercase py-2 px-10  bg-#3E3E3E text-white  font-sans font-normal text-[17px]">CANCEL</button>
                <button class=" uppercase py-2 px-10  bg-dark-orange text-white font-sans font-normal text-[17px]">SUBMIT</button>
            </div>
        </div>
    </div>
</template>
