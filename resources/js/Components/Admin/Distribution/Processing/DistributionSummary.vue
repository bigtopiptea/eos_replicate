    ...
    <template>
        <div class="h-auto w-auto mb-3 border border-red-500">
                ...
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8 ">
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 -mx-4">
                        <table class="min-w-full divide-y divide-gray-300">
                            <thead class="bg-[#D7D7D7] text-[10px] font-bold whitespace-nowrap ">
                                <tr class="divide-x divide-gray-200">
                                    <th scope="col"
                                        class=" flex justify-center space-x-3 py-2 px-1 uppercase tracking-wider  text-center   text-gray-900">
                                        <input type="checkbox" />
                                        <span>
                                        BATCH ID
                                        </span>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white text-[10px]">
                                <tr class="divide-x divide-gray-200">
                                    <td
                                        class="flex justify-center mt-1 whitespace-nowrap space-x-3 text-center uppercase py-2 px-1   tracking-wider">
                                        <input type="checkbox" />
                                        <span>
                                            01
                                        </span>
