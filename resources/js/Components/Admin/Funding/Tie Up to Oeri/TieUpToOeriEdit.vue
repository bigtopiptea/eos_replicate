...
export default{
  components:{
    InputGroup, BorderButton, Accordion, JournalEntry, SolidButton
  },
  props: {
    isOpen:{
        type: Boolean,
        ...
        <div>
          ...
          <form class="flex justify-between items-end h-[225px]">
            <div class="flex flex-col gap-3 w-[35%]">
              ...
              <div>
                <InputGroup :inputLabel="'tieup partner'" :labelWidth="'w-4/12'" :inputWidth="'w-8/12'" :isDisabled="true"/>
              </div>
              <div>
            ...
            <div class="flex flex-col gap-3 w-[28%]">
              ...
              <InputGroup :inputLabel="'dollar transactions'" :labelWidth="'w-6/12'" :inputWidth="'w-6/12'" :isDisabled="true"/>
            </div>
          ...
          <div class="flex gap-[15px] justify-center mt-3">
              ...
              <BorderButton :buttonLabel="'Pass Entry'" :buttonStyle="'border-2 border-red-500 text-red-500 text-[11px]'" :buttonPadding="'px-2 py-2'" :buttonHover="'hover:bg-red-500'"/>
          </div>
        </div>
        <!-- Accordion -->
        <div>
