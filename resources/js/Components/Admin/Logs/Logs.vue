...
export default {
    ...
    data(){
        return{
            ...
            userType:[
                {label: 'ALL USERS'},
                {label: 'ALFARO, LECEL PEREZ'},
                {label: 'ASIS, GINALYN IBARRA'},
                {label: 'BANARIA, JEFFRET CLEDORIO'},
                {label: 'CUENTA, ARNIE LAMBOJO'},
                {label: 'DIAZ, NELLA MARIE TINIO'},
                {label: 'DUPAYA, JOEREN TITO VIERNES'},
                {label: 'LEMITA, ANGELOU CRUZ'},
                {label: 'RANOLA, SHEILA MARIE'}
            ],
            logType:[
                {label: 'ALL LOG TYPES'},
                {label: 'LOGIN'},
